...
const ProductDetails = (props) => {
  ...
  // increase the qty to add to cart
        ...
        <div className="container-lg">
          <div class="row justify-content-center align-items-center">
            ...
            <div className="col-md-5 text-center text-md-start">
              ...
              <Button type="addtocart" className="btn btn-dark btn-block btn-lg col-12" style = {{margin: "10px"}} onClick={() => handleAddToCart(product)}>Add To Cart</Button>
